...
class AddonController extends Controller {
	...
	*/
	...
	{			
		...
		return redirect(env('user').'/addon')->with('message','Đã thêm thành công.');
	}
	...
	*/
	...
	{	
		...
		return redirect(env('user').'/addon')->with('message','Đã cập nhật thành công.');
	}
	...
	*/
	public function delete($id)
	{
		...
		return redirect(env('user').'/addon')->with('message','Đã xoá thành công.');
	}
}