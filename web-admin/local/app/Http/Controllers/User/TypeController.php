...
class TypeController extends Controller {
	...
	*/
	...
	{			
		...
		return redirect(env('user').'/type')->with('message','Đã thêm thành công.');
	}
	...
	*/
	...
	{	
		...
		return redirect(env('user').'/type')->with('message','Đã cập nhật thành công.');
	}
	...
	*/
	public function delete($id)
	{
		...
		return redirect(env('user').'/type')->with('message','Đã xoá thành công.');
	}
}