...
class OrderController extends Controller {
	...
	*/
	...
	public function orderStatus()
	{
		...
		return Redirect::back()->with('message','Trạng thái Đơn hàng Đã Thay đổi Thành công'); 
	}
	...
	public function _edit(Request $Request,$id)
	{
		...
		return Redirect('order?status=1')->with('message','Đơn hàng Chỉnh sửa thành công');
	}
	...
	public function _add(Request $Request)
	{
		...
		return Redirect('order?status=1')->with('message','Đã thêm đơn hàng thành công');
	}
