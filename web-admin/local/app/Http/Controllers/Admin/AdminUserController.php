...
class AdminUserController extends Controller {
	...
	*/
	...
	{			
		...
		return redirect(env('admin').'/adminUser')->with('message','Đã thêm tài khoản mới.');
	}
	...
	*/
	...
	{	
		...
		return redirect(env('admin').'/adminUser')->with('message','Đã cập nhật thông tin.');
	}
	...
	*/
	public function delete($id)
	{
		...
		return redirect(env('admin').'/adminUser')->with('message','Đã xoá.');
	}
	...
	*/
	public function status($id)
	{
		...
		return redirect(env('admin').'/adminUser')->with('message','Cập nhật trạng thái thành công.');
	}
}