...
class LanguageController extends Controller {
	...
	*/
	...
	{			
		...
		return redirect(env('admin').'/language')->with('message','Đã thêm thành công.');
	}
	...
	*/
	...
	{	
		...
		return redirect(env('admin').'/language')->with('message','Đã cập nhật thành công.');
	}
	...
	*/
	public function delete($id)
	{
		...
		return redirect(env('admin').'/language')->with('message','Đã xoá thành công.');
	}
}