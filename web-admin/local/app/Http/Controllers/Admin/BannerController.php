...
class BannerController extends Controller {
	...
	*/
	...
	{			
		...
		return redirect(env('admin').'/banner')->with('message','Đã thêm banner.');
	}
	...
	*/
	...
	{	
		...
		return redirect(env('admin').'/banner')->with('message','Cập nhật banner thànhcông.');
	}
	...
	*/
	public function delete($id)
	{
		...
		return redirect(env('admin').'/banner')->with('message','Đã xoá banner.');
	}
	...
	*/
	public function status($id)
	{
		...
		return redirect(env('admin').'/banner')->with('message','Đã thay đổi trạng thái.');
	}
}