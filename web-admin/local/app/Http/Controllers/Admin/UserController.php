...
class UserController extends Controller {
	...
	*/
	...
	{			
		...
		return redirect(env('admin').'/user')->with('message','Đã thêm thành công.');
	}
	...
	*/
	...
	{	
		...
		return redirect(env('admin').'/user')->with('message','Đã cập nhật thành công.');
	}
	...
	*/
	public function delete($id)
	{
		...
		return redirect(env('admin').'/user')->with('message','Đã xoá thành công.');
	}
	...
	*/
	public function status($id)
	{
		...
		return redirect(env('admin').'/user')->with('message','Đã cập nhật trạng thái thành công.');
	}
	...
	public function loginWithID($id)
	{
		...
		{
		   return Redirect::to('home')->with('message', 'Chào mừng! Bạn đã đăng nhập hệ thống.');	
		}
		else
		{
