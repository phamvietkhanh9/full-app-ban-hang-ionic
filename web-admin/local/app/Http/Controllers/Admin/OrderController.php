...
class OrderController extends Controller {
	...
	*/
	...
	public function orderStatus()
	{
		...
		return Redirect::back()->with('message','Trạng thái đơn hàng đã được thay đổi'); 
	}
	...
	public function _edit(Request $Request,$id)
	{
		...
		return Redirect(env('admin').'/order?status=1')->with('message','Đơn hàng đã được sửa');
	}
	...
	public function _add(Request $Request)
	{
		...
		return Redirect(env('admin').'/order?status=1')->with('message','Đã thêm đơn hàng');
	}
