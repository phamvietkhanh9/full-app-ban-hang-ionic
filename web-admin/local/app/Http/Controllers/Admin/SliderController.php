...
class SliderController extends Controller {
	...
	*/
	...
	{			
		...
		return redirect(env('admin').'/slider')->with('message','Đã thêm thành công.');
	}
	...
	*/
	...
	{	
		...
		return redirect(env('admin').'/slider')->with('message','Đã cập nhật thành công.');
	}
	...
	*/
	public function delete($id)
	{
		...
		return redirect(env('admin').'/slider')->with('message','Đã xoá thành công.');
	}
}