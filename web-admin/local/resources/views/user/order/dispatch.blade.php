...
<h5 class="modal-title" id="slideRightModalLabel">Sẵn sàn giao hàng #{{ $row->id }}</h5>
...
<label for="inputEmail4" >Chọn tùy giao hàng</label>
...
<button type="submit" class="btn btn-primary">Lệnh gửi đơn hàng</button>
</form>
