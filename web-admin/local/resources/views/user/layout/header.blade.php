...
function myTimer() {
    ...
    <nav class=" mr-auto my-auto">
        <ul class="nav align-items-center">
            ...
            <a href="{{ Asset('close') }}" onclick="return confirm('Bạn có chắc?')"><button type="button" class="btn m-b-15 ml-2 mr-2 btn-outline-danger">Đóng cửa ngay</button></a>


            @else

           <a href="{{ Asset('close') }}" onclick="return confirm('Bạn có chắc?')"><button type="button" class="btn m-b-15 ml-2 mr-2 btn-outline-success">Mở cửa ngay</button></a>
