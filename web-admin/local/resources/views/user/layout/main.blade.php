...
<h1 style="text-align: left;font-size: 20px;font-weight: 900">@yield('title')</h1>
@else
<h1 style="text-align: left;margin-left: -8%;font-size: 20px;font-weight: 900">@yield('title')</h1>
@endif
