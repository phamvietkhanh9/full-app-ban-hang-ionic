...
<link rel="icon" type="image/x-icon" href="{{ Asset('assets/img/your-logok.png') }}"/>
<link rel="icon" href="{{ Asset('assets/img/your-logok.png') }}" type="image/png" sizes="16x16">
    ...
    <div class="container-fluid">
        <div class="row ">
            ...
            {{-- <div class="col-lg-7 d-none d-md-block bg-cover">
                <img src="{{Asset('assets/img/login.svg') }}" width="100%" style="margin-top: 7%">
            </div> --}}
        </div>
    </div>
</main>
