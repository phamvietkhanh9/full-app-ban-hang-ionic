...
<a href="{{ Asset($form_url.'/add?remove=about_img') }}" onclick="return confirm('Bạn có chắc?')" style="color:red">Xoá hình</a>
...
<a href="{{ Asset($form_url.'/add?remove=how_img') }}" onclick="return confirm('Bạn có chắc?')" style="color:red">Xoá hình</a>
