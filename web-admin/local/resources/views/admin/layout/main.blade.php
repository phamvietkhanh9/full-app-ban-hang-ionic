...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="{{Asset('assets/img/your-logo.png') }}"/>
    ...
    <script>
      ...
      OneSignal.push(function() {
        OneSignal.init({
          appId: "f55d1ef8-7c95-4c75-9798-d123db8437c0",
          notifyButton: {
            enable: true,
          },
...
<h1 style="text-align: left;margin-left: -8%;font-size: 22px;font-weight: 900">@yield('title')</h1>
@else
<h1 style="text-align: left;font-size: 22px;font-weight: 900">@yield('title')</h1>
@endif
